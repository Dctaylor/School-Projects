...
//     Postcondition: The return value is whether or not the given bag contains a key the
//     original bag contains.
//
...
//    1) # of items is in the variable used
//    2) Empty bag - don't care what's in the data array
//       Non-empty items are stored in data[0] through data[used-1]
//
//
