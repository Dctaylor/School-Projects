...
namespace coen70_lab7
{
    ...
    void list_insert_at(node*& head_ptr, const node::value_type& entry, size_t position)
    {
        ...
        if(position == 1) {
            ...
            node *precursor = list_locate(head_ptr, position - 1);
    ...
    node* list_copy_segment(node* head_ptr, size_t start, size_t finish)
    {
        ...
        node *newHead;
        node *newTail;
        list_copy(head_ptr, newHead, newTail);
        node *begin = list_locate(newHead, start);
        node *end = list_locate(newHead, finish);
        
        list_piece(begin, end, newHead, newTail);
        return newHead;
    }
}
