...
coen70::sequence::size_type sequence::size() const {
    return used;
}
...
coen70::sequence::value_type sequence::current() const {
    assert(is_item());
...
coen70::sequence::value_type sequence::operator[](coen70::sequence::size_type index) const {
